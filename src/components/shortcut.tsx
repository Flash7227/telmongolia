...
const Shortcut = ({title, desc, icon}:{title:string, desc:string, icon:string}) => {
    return (
        <div className="w-[140px] md:w-[200px] border border-brand-1/20 rounded-2xl  overflow-hidden p-2 hover:shadow-lg hover:shadow-brand-1/30 cursor-pointer hover:-translate-y-2 transition-all">
