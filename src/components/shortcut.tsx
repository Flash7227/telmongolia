...
const Shortcut = ({title, desc, icon}:{title:string, desc:string, icon:string}) => {
    return (
        <div className="h-[166px] w-[176px] bg-transperant border border-brand-1/20 rounded-2xl p-2 hover:shadow-md hover:shadow-brand-2/50 cursor-pointer hover:-translate-y-2 transition-all duration-300 relative group flex items-center justify-center">
