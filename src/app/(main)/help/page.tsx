            ...
            <TableCaption>Түгээмэл асуултууд</TableCaption>
                ...
                <TableBody>
                    <TableRow className="cursor-pointer" onClick={()=>openModal(1)}>
                        <TableCell>Багцын үйлчилгээний тариф /байгууллага болон өрх/</TableCell>
                    </TableRow>
                    ...
                    <TableRow className="cursor-pointer" onClick={()=>openModal(5)}>
                        <TableCell>Интернэтийн суурь хураамж болон тариф /байгууллага болон өрх/</TableCell>
                    </TableRow>
                    ...
                    <TableRow className="cursor-pointer" onClick={()=>openModal(7)}>
                        <TableCell>Холболтын хураамж болон суурь хураамжийн тухай</TableCell>
                    </TableRow>
                    ...
                    <TableRow className="cursor-pointer" onClick={()=>openModal(10)}>
                        <TableCell>TVROOM ашиглах заавар /кино захиалан үзэх заавар/</TableCell>
                    </TableRow>
