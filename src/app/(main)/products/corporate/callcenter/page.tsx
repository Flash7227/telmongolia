    ...
    <div>
      ...
      <div className="relative my-[60px]">
        ...
        <div className="flex gap-8 justify-center flex-wrap">
            <Price title="STANDARD Багц" price={"55,000₮"} list={["Толгой дугаар", "Ажлын цагийн тохиргоо", "Автомат хариулагч", "Дуудлага шилжүүлэх", "Техникийн туслалцаа"]}/>
            <Price title="OPERATOR Багц" price={"165,000₮"} list={["Толгой дугаар", "Ажлын цагийн тохиргоо", "Автомат хариулагч", "Дуудлага шилжүүлэх", "Техникийн туслалцаа", "Операторын ачаалал хувиарлах", "Дуудлагыг бүлэглэн ангилах", "Дуудлагын түүх, тайлан", "Оператор түр завсарлах", "IVR хоолой"]}/>
        </div>
        <h5 className="my-4 text-lg font-medium text-center">Шилэн кабел Call center</h5>
        <div className="flex gap-8 justify-center flex-wrap">
            <Price title="S Багц" price={"55,000₮"} list={["Толгой дугаар", "Ажлын цагийн тохиргоо", "Автомат хариулагч", "Дуудлага шилжүүлэх", "Дотуур дугаар - 2ш", "Дуудлага хүлээлгэх - 2ш"]}/>
            <Price title="OPERATOR Багц" price={"165,000₮"} list={["Толгой дугаар", "Ажлын цагийн тохиргоо", "Автомат хариулагч", "Дуудлага шилжүүлэх", "Дотуур дугаар - 5ш", "Дуудлага хүлээлгэх - 5ш", "Дуудлагыг бүлэглэн ангилах", "Дуудлагын түүх, тайлан", "Оператор түр засварлах", "IVR хоолой бичүүлэх"]}/>
            <Price title="BUSINESS Багц" price={"385,000₮"} list={["Толгой дугаар", "Ажлын цагийн тохиргоо", "Автомат хариулагч", "Дуудлага шилжүүлэх", "Нөхцөл зааж дуудлага шилжүүлэх", "Хариу өгөөгүй тохиолдолд дуудлага шилжүүлэх", "Ажлын цагийн тохиргоо", "Яриа хийж байхад дуудлага шилжүүлэх", "Хяналтын самбар, тайлан статистик", "Дуудлагын түүх", "Дуудлагын түүх хадгалах хугацаа"]}/>
        </div>
      </div>
      {/* user comments */}
      <div className="relative my-[60px]">
