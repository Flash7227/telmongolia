    ...
    <div>
      ...
      <div className="relative my-[60px]">
        ...
        <div className="flex gap-8 justify-center flex-wrap">
            <Price title="S Багц" price={"55,000₮"} list={["Анхны холболтын хураамж 16,500₮", "Интернэтийн хурд 10Мbps", "Сүлжээндээ болон 26хххх дугаар руу яриа Хязгааргүй", "Бусад сүлжээнд 400 минут", "Нэмэлт үйлчилгээ 5ш"]}/>
            <Price title="M Багц" price={"99,000₮"} list={["Анхны холболтын хураамж 16,500₮", "Интернэтийн хурд 30Мbps", "Сүлжээндээ болон 26хххх дугаар руу яриа Хязгааргүй", "Бусад сүлжээнд 600 минут", "Нэмэлт үйлчилгээ 7ш"]}/>
        </div>
